...
class JobSiteHibbettSports extends BasePluginiCIMS
{
...
class JobSiteFredHutch extends BasePluginiCIMS
{
    protected $siteName = 'FredHutch';
    protected $siteBaseURL = "https://hub-fhcrc.icims.com";
    protected $nJobListingsPerPage = 167;

    // Results Columns:  "Posting date", "Job ID", "Job title", "Department", "Location", "Remote BasePlugin"
...
class JobSiteRedHat extends BasePluginiCIMS
{
...
class JobSiteParivedaSolutions extends BasePluginiCIMS
{
...
{
    protected $additionalFlags = [C__JOB_ITEMCOUNT_NOTAPPLICABLE, C__JOB_DAYS_VALUE_NOTAPPLICABLE, C__JOB_LOCATION_URL_PARAMETER_NOT_SUPPORTED];
