...
class BaseForceComClass extends \Jobscooper\BasePlugin\ClientSideHTMLJobSitePlugin
{
...
class JobSiteAltasource extends BaseForceComClass
{
...
class JobSiteSlalom extends BaseForceComClass
{
    function __construct()
    {
...
class JobSiteRobertHalfExecSearch extends BaseForceComClass
{
