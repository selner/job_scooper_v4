...
class JobSiteEntercom extends BaseTaleoPlugin
{
...
class JobSiteSeattleGenetics extends BaseTaleoPlugin
{
...
class JobSiteInternetBrands extends BaseTaleoPlugin
{
...
class JobSiteTraderJoes extends BaseTaleoPlugin
{
    protected $use1ToTDForCount = True;
...
class JobSitePorch extends BaseTaleoPlugin
{
    protected $use1ToTDForCount = True;
...
abstract class BaseTaleoPlugin extends \Jobscooper\BasePlugin\ServerHTMLJobSitePlugin
{
