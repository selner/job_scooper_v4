 ...
 * Class KellyServices
 *
 *       Used by KellyServices.json plugin configuration to override single method
 */
abstract class KellyServices extends \Jobscooper\BasePlugin\ClientSideHTMLJobSitePlugin
{
