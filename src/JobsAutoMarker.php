...
class JobsAutoMarker extends \Jobscooper\BasePlugin\JobsSiteCommon
{
    ...
    function __construct($arrJobs_Unfiltered = array(), $strOutputDirectory = null)
    {
        ...
        $this->cbsaList = loadJSON(__ROOT__.'/src/static/cbsa_list.json');
        $cbsaCityMapping = loadCSV(__ROOT__.'/src/static/us_place_to_csba_mapping.csv', 'PlaceKey');
