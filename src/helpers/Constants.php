...
const C__JOB_USE_SITENAME_AS_COMPANY = 0x4;
const C__JOB_SUPPORTS_MULTIPLE_LOCS_PER_JOB = 0x8;

const C__JOB_KEYWORD_URL_PARAMETER_NOT_SUPPORTED = 0x10;
const C__JOB_LOCATION_URL_PARAMETER_NOT_SUPPORTED = 0x20;
const C__JOB_URL_USE_DISPLAYNAME = 0x40;
...
const C__JOB_PAGECOUNT_OMIT_ON_FIRST_PAGE = 0x2000;
const C__JOB_ITEMCOUNT_NOTAPPLICABLE = 0x4000;
const C__JOB_ITEMCOUNT_STARTSATZERO = 0x8000;

const C__JOB_KEYWORD_REQUIRES_LOWERCASE = 0x10000;
const C__JOB_LOCATION_PARAMETER_SPACES_AS_PLUSES = 0x20000;
const C__JOB_LOCATION_PARAMETER_SPACES_AS_DASHES = 0x40000;
