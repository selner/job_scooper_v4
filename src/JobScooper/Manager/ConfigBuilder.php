...
//        $GLOBALS['SETTINGS_CACHE_FILE'] = generateOutputFileName( "settings-cache", "json", true, 'debug');
//        $cfgmgr = new ConfigManager($configFile=$GLOBALS['SETTINGS_CACHE_FILE'], $configData = $configFile=$GLOBALS['USERDATA']);
//        $cfgmgr->saveConfig();
//
