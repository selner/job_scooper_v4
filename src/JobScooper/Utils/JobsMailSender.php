...
class JobsMailSender
{
     ...
     */
    public function __construct($alwaysNotify = false)
    {
     ...
     * @throws \Exception
     */
    public function sendEmail($strBodyText = null, $strBodyHTML = null, $arrAttachFilePaths = array(), $subject='No subject', $emailKind='results', User $toUser = null)
    {
        $ret = false;
