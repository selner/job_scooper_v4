...
//            $classCombined->writeArrayToCSVFile($arrJobsRecordsToUse, $keysToOutput, $this->arrKeysForDeduping);
    ...
    private function _getResultsTextHTML_($arrHeaders, $arrCounts, $detailsHTMLBodyInclude = null)
    {
        ...
        if($arrCounts != null && count($arrCounts) > 0)
        {
            $strOut  .= "<hr width='100%'><br><H2>Search Results by Job Site</H2>".PHP_EOL. PHP_EOL;
...
//        }
        ...
        $strOut  .= "<div style=\"width: 100%; margin-top:  20px; text-align: right;\"><span style=\"font-size: xx-small; color: #49332D;\">Generated by " . gethostname() . " running " . __APP_VERSION__. " on " . getTodayAsString() . ".</span></div>" . PHP_EOL;
