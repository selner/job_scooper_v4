...
//		}
		...
		$messageHtml = $this->_generateHTMLEmailContent("JobScooper for " . getRunDateRange(), $arrMatchedJobs);
	 ...
	 * @throws \Exception
	 */
	private function _generateHTMLEmailContent($subject, $arrMatchedJobs)
	{
