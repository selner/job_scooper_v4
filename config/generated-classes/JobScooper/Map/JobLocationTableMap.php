...
use JobScooper\JobLocation;
use JobScooper\JobLocationQuery;
...
class JobLocationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'JobScooper.Map.JobLocationTableMap';
     ...
     */
    const OM_CLASS = '\\JobScooper\\JobLocation';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'JobScooper.JobLocation';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\JobScooper\\JobLocation');
    ...
    {
        $this->addRelation('JobPosting', '\\JobScooper\\JobPosting', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':job_location_id',
    1 => ':location_id',
        ...
        $this->addRelation('JobPlaceLookup', '\\JobScooper\\JobPlaceLookup', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':job_location_id',
    1 => ':location_id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \JobScooper\JobLocation) { // it's a model object
