...
class UserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'JobScooper.Map.UserTableMap';
     ...
     */
    const OM_CLASS = '\\JobScooper\\User';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'JobScooper.User';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\JobScooper\\User');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \JobScooper\User) { // it's a model object
