...
use JobScooper\JobPlaceLookup;
use JobScooper\JobPlaceLookupQuery;
...
class JobPlaceLookupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'JobScooper.Map.JobPlaceLookupTableMap';
     ...
     */
    const OM_CLASS = '\\JobScooper\\JobPlaceLookup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'JobScooper.JobPlaceLookup';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\JobScooper\\JobPlaceLookup');
  ...
  array (
    ...
    {
        return array(
            'sluggable' => array('slug_column' => 'slug', 'slug_pattern' => '', 'replace_pattern' => '/\W+/', 'replacement' => '-', 'separator' => '-', 'permanent' => 'false', 'scope_column' => '', 'unique_constraint' => 'true', ),
        );
    } // getBehaviors()
     ...
     * and findPk*() calls.
     *
     * @param \JobScooper\JobPlaceLookup $obj A \JobScooper\JobPlaceLookup object.
     ...
     *
     * @param mixed $value A \JobScooper\JobPlaceLookup object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \JobScooper\JobPlaceLookup) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \JobScooper\JobPlaceLookup object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \JobScooper\JobPlaceLookup) { // it's a model object
