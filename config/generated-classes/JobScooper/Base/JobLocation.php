...
abstract class JobLocation implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\JobScooper\\Map\\JobLocationTableMap';
    ...
    /**
     * Initializes internal state of JobScooper\Base\JobLocation object.
     */
     ...
     * @return $this|\JobScooper\JobLocation The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\JobScooper\\JobLocation'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->jobPlaceLookupsScheduledForDeletion !== null) {
                if (!$this->jobPlaceLookupsScheduledForDeletion->isEmpty()) {
                    \JobScooper\JobPlaceLookupQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\JobScooper\JobLocation
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\JobScooper\JobLocation The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \JobScooper\JobLocation (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \JobScooper\JobLocation Clone of current object.
     * @throws PropelException
     */
    ...
    public function initJobPlaceLookups($overrideExisting = true)
    {
        ...
        $this->collJobPlaceLookups->setModel('\JobScooper\JobPlaceLookup');
    }
