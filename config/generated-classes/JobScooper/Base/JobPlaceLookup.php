...
abstract class JobPlaceLookup implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\JobScooper\\Map\\JobPlaceLookupTableMap';
    ...
    /**
     * Initializes internal state of JobScooper\Base\JobPlaceLookup object.
     */
     ...
     * @return $this|\JobScooper\JobPlaceLookup The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\JobScooper\\JobPlaceLookup'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\JobScooper\JobPlaceLookup
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\JobScooper\JobPlaceLookup The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \JobScooper\JobPlaceLookup (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \JobScooper\JobPlaceLookup Clone of current object.
     * @throws PropelException
     */
    ...
    protected function makeSlugUnique($slug, $separator = '-', $alreadyExists = false)
    {
        if (!$alreadyExists) {
            ...
            $count = \JobScooper\JobPlaceLookupQuery::create()
        ...
        $query = \JobScooper\JobPlaceLookupQuery::create('q')
