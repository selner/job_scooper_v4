...
from dataprocessor.tasks.match_titles import TaskMatchJobsToKeywords
from dataprocessor.utils.log  import logmsg


cli_usage = """
Usage:
  {} -i <file> -o <file> (-c <dbstring> | --dsn <dbstring> | --host <hostname> --port <portid> --database <dbstring> --user <userstring> --password <userpass>)
  {} --version
