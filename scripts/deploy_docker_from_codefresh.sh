...
ECHO ""
ECHO "***************************************************************"
DOCKER_RUN="docker run --volume /private/var/local/jobs_scooper:/var/local/jobs_scooper --volume /Users/bryan/nltk_data:/root/nltk_data --name $CONTAINER_NAME $DOCKER_IMAGE" 
echo $DOCKER_RUN
$DOCKER_RUN
