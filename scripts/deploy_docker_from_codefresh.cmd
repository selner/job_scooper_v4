...
ECHO ""
ECHO "***************************************************************"
docker login r.cfcr.io -u bryanselner -p 6f581c3a4aa151ca24ffaf544acf9515
...
ECHO "***************************************************************"
ECHO ""
ECHO "Pulling most recent Docker image for %IMAGETAG%
ECHO ""
ECHO "***************************************************************"
docker pull r.cfcr.io/bryanselner/js4-%BRANCH%/latest
...
ECHO ""
ECHO "***************************************************************"
docker run --volume C:\var\local\jobs_scooper:/var/local/jobs_scooper --volume c:\dev\nltk_data:/root/nltk_data --hostname %COMPUTERNAME%_docker --name %jobsname% -d %imagetag% -C "bash -C '/opt/jobs_scooper/userfiles/scoop_docker.sh;/bin/bash';'bash'"
