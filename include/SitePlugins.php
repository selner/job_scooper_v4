...
const C__JOB_LOCATION_URL_PARAMETER_NOT_SUPPORTED = 0x100;
const C__JOB_LOCATION_REQUIRES_LOWERCASE = 0x200;
const C__JOB_KEYWORD_URL_PARAMETER_NOT_SUPPORTED = 0x400;
const C__JOB_KEYWORD_PARAMETER_SPACES_AS_DASHES = 0x800;
...
const C__JOB_ALWAYS_ADD_FULL_KEYWORDS_SET = 0x10000;  // Used to override the default behavior of creating multiple searches when a search returns all jobs.
