...
const C__JOB_LOCATION_PARAMETER_NOT_SUPPORTED = 0x100;
const C__JOB_KEYWORD_PARAMETER_NOT_SUPPORTED = 0x200;
const C__JOB_PAGECOUNT_NOTAPPLICABLE__= 0x400;
const C__JOB_DAYS_VALUE_NOTAPPLICABLE__ = 0x800;
const C__JOB_ITEMCOUNT_NOTAPPLICABLE__ = 0x1000;
