...
const C__JOB_SEARCH_RESULTS_TYPE_NONE__ = 0x0;
const C__JOB_SEARCH_RESULTS_TYPE_WEBPAGE__ = 0x1;
const C__JOB_SEARCH_RESULTS_TYPE_XML__= 0x2;
const C__JOB_SEARCH_RESULTS_TYPE_HTML_FILE__ = 0x4;
...
const C__JOB_LOCATION_PARAMETER_NOT_SUPPORTED = 0x1000;
const C__JOB_KEYWORD_PARAMETER_NOT_SUPPORTED = 0x2000;
const C__JOB_KEYWORD_PARAMETER_SPACES_AS_DASHES = 0x4000;
const C__JOB_KEYWORD_MULTIPLE_TERMS_ALLOWED = 0x8000;
...
define('C__JOB_BASETYPE_HTML_DOWNLOAD_FLAGS_NO_LOCATION_OR_KEYWORDS', C__JOB_BASETYPE_HTML_DOWNLOAD_FLAGS | C__JOB_LOCATION_PARAMETER_NOT_SUPPORTED | C__JOB_KEYWORD_PARAMETER_NOT_SUPPORTED);
...
define('C__JOB_BASETYPE_NONE_NO_LOCATION_OR_KEYWORDS', C__JOB_SEARCH_RESULTS_TYPE_NONE__ | C__JOB_LOCATION_PARAMETER_NOT_SUPPORTED | C__JOB_KEYWORD_PARAMETER_NOT_SUPPORTED);
define('C__JOB_BASETYPE_WEBPAGE_FLAGS_NO_LOCATION', C__JOB_BASETYPE_WEBPAGE_FLAGS | C__JOB_LOCATION_PARAMETER_NOT_SUPPORTED);
define('C__JOB_BASETYPE_WEBPAGE_FLAGS_NO_KEYWORDS', C__JOB_BASETYPE_WEBPAGE_FLAGS | C__JOB_KEYWORD_PARAMETER_NOT_SUPPORTED);
define('C__JOB_BASETYPE_WEBPAGE_FLAGS_NO_LOCATION_OR_KEYWORDS', C__JOB_BASETYPE_WEBPAGE_FLAGS | C__JOB_LOCATION_PARAMETER_NOT_SUPPORTED | C__JOB_KEYWORD_PARAMETER_NOT_SUPPORTED);
define('C__JOB_BASETYPE_WEBPAGE_FLAGS_MULTIPLE_KEYWORDS', C__JOB_BASETYPE_WEBPAGE_FLAGS | C__JOB_KEYWORD_MULTIPLE_TERMS_ALLOWED);
