...
const C__JOB_KEYWORD_MULTIPLE_TERMS_SUPPORTED = 0x8000;
const C__JOB_KEYWORD_SUPPORTS_QUOTED_KEYWORDS = 0x10000;
const C__JOB_KEYWORD_SUPPORTS_PLUS_PREFIX = 0x20000;
DEFINE ('C__JOB_BASE_URL_FORMAT_REQUIRED', 0x40000 | C__JOB_KEYWORD_URL_PARAMETER_NOT_SUPPORTED | C__JOB_LOCATION_URL_PARAMETER_NOT_SUPPORTED);
