...
//            $arrFailedPluginsReport[$search['site_name']][$search['key']] = $search;
    ...
    private function _getResultsTextHTML_($arrHeaders, $arrCounts, $arrFailedPlugins = null, $detailsHTMLBodyInclude = null)
    {
        ...
        $strOut .=  PHP_EOL . "<div class=\"job_scooper section\">". PHP_EOL;
        $strOut .=  PHP_EOL .  "<p style=\"min-height: 15px;\">&nbsp;</p><span style=\"font-size: xx-small; color: SlateBlue;\">Generated by " . __APP_VERSION__. " on " . \Scooper\getTodayAsString() . ".</span>" . PHP_EOL;
        $strOut .= "</div>";
        $strOut .= "<br>" . PHP_EOL . "<br>" . PHP_EOL;
